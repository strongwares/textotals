...
const Possibilities = (
  <div className="helpscreen-item">
    ...
    <h4 className="p-mt-0 p-mb-3">{C.APP_NAME} just tracks numbers.</h4>

    <h4 className="p-mt-0 p-mb-3">
      You can track almost anything, like time or eating.
    </h4>
    ...
    <ul>
      ...
      <li>
        the "READING" account in the "SCHOOL" group starting total is 24 hours
      </li>
    ...
    <div style={{ marginTop: '5px' }}>
      ...
      <div className="action-item-action">points spend 5 on breakfast</div>
      <div className="action-item-action">points spend 3 on mid day snack</div>
    </div>
    <ul>
      ...
      <li>
        the "MAIN" account in the "POINTS" group starting total is 24 points
      </li>
      <li>
        the category name "breakfast" is the breakfast you ate worth 5 points
      </li>
      <li>
        the category name "mid day snack" is something you ate worth 3 points
      </li>
      <li>
        the Accounts tab will show you have 16 left on the "POINTS" group "MAIN"
        account
      </li>
      <li>
